...
```bash
codex "output_file.md" "input_directory_pat"
```
...
```
### Skipping files & folders Paths
```bash
codex "output_file.md" "input_directory_pat" "skip['.file_extention', 'file_name.file_extention']"
```  
